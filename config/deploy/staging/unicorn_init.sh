...
### BEGIN INIT INFO
# Provides:          Hours_unicorn_initialization
# Required-Start:    $remote_fs $syslog
# Required-Stop:     $remote_fs $syslog
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: Hours unicorn initialization
...
##### SET THESE VARIABLES ########
##################################
AS_USER=hours # name of user on server
APP_ROOT=/home/hours/The-Hours/current # path to application current folder
